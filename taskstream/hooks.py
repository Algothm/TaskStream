...
app_include_css = ["taskstream.bundle.css"]
...
scheduler_events = {
	"daily": [
		...
		"taskstream.taskstream.tasks.update_score.update_score",
	],
	...
	"cron": {
		...
		# ],
		"1 0 * * *": [
			"taskstream.taskstream.tasks.disable_work_item.expire_work_items",
			"taskstream.taskstream.tasks.recurrence_mark_as_closed.update_done_to_closed",
		],
	},
}
